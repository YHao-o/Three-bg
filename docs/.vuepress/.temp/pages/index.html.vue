...
<blockquote>
<p>这就是一个防止我忘记three.js咋用的简单组件库，目前主要用于网页背景</p>
</blockquote>
<h4 id="_1-安装组件库" tabindex="-1"><a class="header-anchor" href="#_1-安装组件库" aria-hidden="true">#</a> 1.安装组件库</h4>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">npm</span> i three-bc
or
<span class="token function">yarn</span> <span class="token function">add</span> three-bc
...
<span class="token keyword">import</span> <span class="token constant">THREE</span><span class="token operator">-</span><span class="token constant">BG</span> <span class="token keyword">from</span> <span class="token string">'three-bc'</span>

vue<span class="token punctuation">.</span><span class="token function">use</span><span class="token punctuation">(</span><span class="token constant">THREE</span><span class="token operator">-</span><span class="token constant">BG</span><span class="token punctuation">)</span>
<span class="token comment">//按需引入</span>
<span class="token keyword">import</span> <span class="token punctuation">{</span> Background2To3 <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'three-bc'</span>
